...
class Settings(BaseSettings):
    ...
    student_id: Optional[str] = Field(default=None, alias="SGU_STUDENT_ID")
    password: Optional[str] = Field(default=None, alias="SGU_PASSWORD")
    bearer_token: Optional[str] = Field(default=None, alias="SGU_BEARER_TOKEN")
    ...
    # Cấu hình MCP Server
    mcp_host: str = Field(default="0.0.0.0", alias="MCP_SERVER_HOST")
