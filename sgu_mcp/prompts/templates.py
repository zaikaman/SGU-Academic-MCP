...
SGU_PROMPTS = {
    "plan_weekly_routine": {
        ...
        "arguments": [
            {"name": "target_hours_per_day", "description": "Số giờ muốn dành cho tự học mỗi ngày (ví dụ: 3)", "required": False}
        ],
...
3. Lập một thời gian biểu chi tiết gồm:
   ...
   - Thời gian nghỉ ngơi, thể thao cân bằng sức khỏe."""
    ...
    "exam_cramming_strategy": {
        ...
        "arguments": [
            {"name": "priority_courses", "description": "Tên các môn học cảm thấy yếu nhất cần ưu tiên ôn tập", "required": False}
        ],
